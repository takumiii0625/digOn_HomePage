...
<body class="antialiased">
    <div class="content-container">
        ...
        <p class=title>　OBFall株式会社が提供する音楽アプリdigOn（以下、「本アプリ」といいます。）の有償サブスクリプションサービスに関する特定商取引法に基づく表示は以下のとおりです。</p>
        ...
        <ol>
            ...
            <li>
                ...
                <p>digOnは、モバイルアプリとしてお楽しみいただけます。</p>
                <p>動作環境は以下のとおりです。</p>

                <p>アプリ</p>
                <p>Android</p>
                <p>　- digOnバージョン1.0.0以降：Android 5.0以降</p>

                <p>iOS</p>
                <p>　- digOnバージョン1.0.0以降：iOS 11.0以降</p>
            </li>
            <li>
            ...
            <li>
                ...
                <p>dig-on@obfall.co.jp</p>
            </li>
        </ol>

        <p style="text-align: right;">以上</p>
        <p style="text-align: right;">令和6年9月1日　制定</p>
